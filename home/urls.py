...
from .views import IndexView,FaviconView,LoginView,SignupView,PasswordChangeView,DashboardView,FeedbackView,LogoutView,ProfileView, demo
urlpatterns = [
    ...
    path("profile/",ProfileView.as_view(),name="profile"), # Feedback Page
